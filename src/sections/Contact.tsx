      ...
      <section className="section contact" id="contact">
        <motion.div className="wrap" variants={stagger} {...inView}>
          ...
          <motion.div className="socials" variants={fadeUp}>
            ...
            {/* peer of the other channels, not a second accent CTA — the nav pill is the
                primary, and two competing primaries on one screen split attention */}
            <a href={profile.resumeUrl} target="_blank" rel="noopener">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v5h5" /><path d="M9 13h6" /><path d="M9 17h4" /></svg>
              Resume
            </a>
          </motion.div>
        </motion.div>
