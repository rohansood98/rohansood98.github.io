...
export const profile = {
  ...
  projects: [
    ...
    },
    {
      ...
      access: 'Open source · a Lisnara app',
      href: 'https://github.com/rohansood98/keepsy',
    },
    {
      title: 'NewsAI',
      ...
      access: 'Open source',
      href: 'https://github.com/rohansood98/newsai',
    },
    {
      title: 'AutoDoc AI',
  ...
  hobby: {
    ...
    body: 'I run an independent studio for my own apps — calm, human software I actually want to use. First out the door is Keepsy.',
